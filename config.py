...
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [5953732299]
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)

UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/ma7amad2000/TOMMY")
...
START_IMG_URL = getenv("START_IMG_URL", "https://k.top4top.io/p_2706s63yo1.jpg")
...
if PING_IMG_URL:
    if PING_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", PING_IMG_URL):
            PING_IMG_URL = "https://k.top4top.io/p_2706s63yo1.jpg"

if START_IMG_URL:
    if START_IMG_URL != "assets/Ping.jpeg":
        if not re.match("(?:http|https)://", START_IMG_URL):
            START_IMG_URL = "https://k.top4top.io/p_2706s63yo1.jpg"

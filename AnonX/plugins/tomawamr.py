...
async def cr_source(client: Client, message: Message):
    await message.reply_photo(
        ...
        caption=f"""**⩹━★⊷━⌞  𓏺َِ᥉َِ᥆َِꪊَِᖇَِᥴُِ꧖ ᥒَِ᥆َِᖇَِꫝُِꪖَِᥒ ⌝━⊶★━⩺**\nمرحبا بك عزيزي {message.from_user.mention}\nهذا قسم الاوامر الخاص بسورس نورهان \nلمعرفة الاوامر اضغط على الأزرار بالأسفل👇\n**⩹━★⊷━⌞  𓏺َِ᥉َِ᥆َِꪊَِᖇَِᥴُِ꧖ ᥒَِ᥆َِᖇَِꫝُِꪖَِᥒ⌝━⊶★━⩺**""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton(
                        "★⌞ 𓏺َِ᥉َِ᥆َِꪊَِᖇَِᥴُِ꧖ ᥒَِ᥆َِᖇَِꫝُِꪖَِᥒ ⌝⚡", url=f"https://t.me/Libya13n"),
                ],
...
async def cr_usage(_, callback_query: CallbackQuery):
    ...
    await callback_query.message.edit_text(
        text="""**⩹━★⊷⌯⌞ 𓏺َِ᥉َِ᥆َِꪊَِᖇَِᥴُِ꧖ ᥒَِ᥆َِᖇَِꫝُِꪖَِᥒ ⌝⌯⊶★━⩺**
